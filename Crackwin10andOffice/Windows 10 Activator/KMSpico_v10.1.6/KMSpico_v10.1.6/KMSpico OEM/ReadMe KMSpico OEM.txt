...
1. Copy the "$OEM$" Folder inside the "sources" folder in Windows ISO installation.
...
also for W10TP/8.1/2012R/ServerTP the files  %WinDir%\SECOH-QAD.exe.
...
SHA1     : 791be97580fd001a065e7af87d5428dfaa071341
